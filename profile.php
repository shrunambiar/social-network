...
<title><?php 
//www.freestudentprojects.com echo $_SESSION['SESS_FIRST_NAME'];?> Profile</title>
...
<?php 
//www.freestudentprojects.com include("top.php"); ?>
...
//www.freestudentprojects.com echo $_SESSION['SESS_FIRST_NAME'];?>"/>
		 <input name="poster" type="hidden" id="name" value="<?php 
//www.freestudentprojects.com echo $_SESSION['SESS_FIRST_NAME'];?>"/>
		 <input name="name1" type="hidden" id="name" value="<?php 
//www.freestudentprojects.com echo $_SESSION['SESS_LAST_NAME'];?>"/>
