...
<title><?php 
//www.freestudentprojects.com echo $_SESSION['SESS_FIRST_NAME'];?> Friends List</title>
...
while($row = mysql_fetch_array($result))
 ...
 echo '<a href=friendsprofile1.php?id=' . $row["friends_id"] . '>' . "<img width=100 height=100 alt='Unable to View' src='". $row["location"] . "'>" . '</a>';
