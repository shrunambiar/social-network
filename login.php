...
<table width="389" align="center">
  ...
  <tr>
    ...
    <td width="202"><div class="input-container"><input name="login" type="text" id="login" size="40" />
    </div></td>
  </tr>
  <tr>
    <td height="40"><label for="lname">Password :</label></td>
    <td><div class="input-container"><input name="password" type="password" id="password" size="40" />
    </div></td>
  </tr>
