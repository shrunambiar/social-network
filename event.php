...
{?>
   <div class="show_event">
	   ...
	   <b><?php 
//www.freestudentprojects.com echo $row['EventInput'];?></b>
	   <br />
	   <?php 
//www.freestudentprojects.com echo $row['where_text'];?>
	   <br />
	   <?php 
//www.freestudentprojects.com echo date("F d, Y h:ia",$row['datepicker']);?>
	   </label>

	   <a href="event.php?eventid=<?php 
//www.freestudentprojects.com  echo $row['id']?>" >x</a>
		<br clear="all" />
   </div>
<?php 
//www.freestudentprojects.com
