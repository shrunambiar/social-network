...
//www.freestudentprojects.com  echo $row['p_id']?>">
	   ...
	   <img src="99.jpeg" style="float:left;" alt="" />
		   ...
		   <b><?php 
//www.freestudentprojects.com echo $row['f_name'];?></b>

		   <em><?php 
//www.freestudentprojects.com  echo clickable_link($row['post']);?></em>
		   <br clear="all" />
...
//www.freestudentprojects.com  echo $row['p_id']?>" class="showCommentBox">Comments</a>
...
//www.freestudentprojects.com  echo $rows['c_id'];?>" align="left">
						<img src="small.png" width="40" class="CommentImg" style="float:left;" alt="" />
						<label class="postedComments">
							<?php 
//www.freestudentprojects.com  echo clickable_link($rows['comments']);?>
						</label>
						<br clear="all" />
...
//www.freestudentprojects.com
						...
						&nbsp;&nbsp;<a href="#" id="CID-<?php 
//www.freestudentprojects.com  echo $rows['c_id'];?>" class="c_delete">Delete</a>
						<?php 
//www.freestudentprojects.com
						}?>
					</div>
...
//www.freestudentprojects.com  echo $row['p_id'];?>" <?php 
//www.freestudentprojects.com echo (($comment_num_row) ? '' :'style="display:none"')?>>
				<img src="small.png" width="40" class="CommentImg" style="float:left;" alt="" />
				<label id="record-<?php 
//www.freestudentprojects.com  echo $row['p_id'];?>">
					<textarea class="commentMark" id="commentMark-<?php 
//www.freestudentprojects.com  echo $row['p_id'];?>" name="commentMark" cols="60"></textarea>
				</label>
				<br clear="all" />
...
//www.freestudentprojects.com
	...
	<a id="more_<?php 
//www.freestudentprojects.com echo @$next_records?>" class="more_records" href="javascript: void(0)">Older Posts</a>
	</div>
	<?php 
//www.freestudentprojects.com
	}?>
